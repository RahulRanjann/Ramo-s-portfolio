  ...
  return (
    <section id="education" className="education-section" ref={sectionRef}>
      ...
      <div className="edu-container">
        ...
        {/* CTA Section */}
        <div className="edu-cta animate-on-scroll">
          <div className="cta-glow cta-glow-1"></div>
          <div className="cta-glow cta-glow-2"></div>
          <div className="cta-content">
            <span className="material-symbols-outlined cta-icon">folder_open</span>
            <h2 className="cta-title">Full Academic Record</h2>
            <p className="cta-text">
              Access detailed transcripts, thesis publications, and complete curriculum vitae.
            </p>
